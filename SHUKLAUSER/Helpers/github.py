...
def github():
    ...
    try:
        repo = Repo()
        LOGGER("SHUKLAUSER").info(f"Git Client Found [VPS DEPLOYER] !")
    except GitCommandError:
        LOGGER("SHUKLAUSER").info(f"Invalid Git Command !")
        ...
        LOGGER("SHUKLAUSER").info(f"Fetched Updates From stranger !")
